...
<section class="hero text-white text-center py-5" style="background: linear-gradient(135deg, #343a40, #17a2b8);">
    <div class="container">
        <h1 class="display-4 fw-bold">Lista de Servicios</h1>
        <p class="lead mt-3">Encuentra los servicios disponibles para el cuidado de tus mascotas. Agrega, edita o elimina servicios según tus necesidades.</p>
    </div>
</section>
